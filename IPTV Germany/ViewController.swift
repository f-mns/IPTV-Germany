...
class ViewController: UIViewController {
    ...
    @IBAction func zdf() {
        streamurl = "https://zdf-hls-15.akamaized.net/hls/live/2016498/de/veryhigh/master.m3u8"
        startPlayer()
    }
    ...
    @IBAction func servus() {
        streamurl = "https://stv-live.akamaized.net/hls/live/2031020/lingeoSTVDEwebBU/master.m3u8"
        startPlayer()
    }
